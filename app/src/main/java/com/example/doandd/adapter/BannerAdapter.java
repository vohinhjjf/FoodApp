...
public class BannerAdapter extends PagerAdapter {
    ...
    private List<Integer> theSlideItemsModelClassList;


    public BannerAdapter(Context Mcontext, List<Integer> theSlideItemsModelClassList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View sliderLayout = inflater.inflate(R.layout.item_image,null);
